...
<body>
  ...
  <div class="grid cols">
    ...
    <div class="card">
      ...
      <div id="pagination" class="row" style="justify-content:space-between;margin-top:12px;gap:8px">
...
function updateLetterNavigation(){
  ...
  const totalLetterPages = Math.ceil(allLetters.length / lettersPerPage);
  const start = currentLetterPage * lettersPerPage;
  ...
  if (totalLetterPages > 1) {
    if (currentLetterPage > 0) {
      html = `<button class="btn" onclick="changeLetterPage(${currentLetterPage - 1})">Prev</button>` + html;
    }
    if (currentLetterPage < totalLetterPages - 1) {
      html += `<button class="btn" onclick="changeLetterPage(${currentLetterPage + 1})">Next</button>`;
    }
  }
