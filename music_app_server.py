  ...
  <div class="grid cols">
    ...
    <div class="card">
      ...
      <div class="row" style="justify-content:space-between;margin-top:10px">
        <div class="row" style="gap:8px">
          <button class="btn" onclick="window.open('https://github.com/csilvertooth/apple_music_server_macos', '_blank')" title="View on GitHub">
...
def get_media_players():
    ...
    for device in airplay_status:
        ...
        repeat_mode = master_now.get('repeat', 'off')
